...
50.times do |_index|
  ...
  5.times do |_j|
    product.reviews.create!(author: user.username, content_body: Faker::Lorem.paragraph(sentence_count: 20, supplemental: false, random_sentences_to_add: 0), rating: Faker::Number.within(range: 1..5))
  end
end
